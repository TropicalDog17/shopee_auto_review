...
//   "ws://127.0.0.1:9222/devtools/browser/95d46d96-a6cb-4800-a364-e106508d7583";
const REVIEW_LINK =
  "https://shopee.vn/user/purchase/order/110600066186722?type=3";
...
(async () => {
  const browser = await puppeteer.connect({
    browserWSEndpoint:
      "ws://127.0.0.1:9222/devtools/browser/46fa616b-6b56-4bcc-9018-12766d0b718e",
  ...
  console.log(elUploadArray.length);
  ...
  uploadAllFiles();
  // for (const url of imageURLsList) {
  //   let img_name = makeid(10) + ".jpg";
  //   imgList.push(img_name);
  //   await download_image(url, img_name);
  //   await page.waitForTimeout(100);
  // }
  // for (const el of elImageArray) {
  //   let imgPath = __dirname + `\\${imgList[index++]}`;
  //   await el.uploadFile(imgPath);
